		...
		<div class="container">
			<div class="row">
				<div style="border: 1px solid #e4e4e4;width:930px;margin-bottom:10px;margin:0 auto;padding:10px;margin-bottom:10px;">
					<a href="${pageContext.request.contextPath }/index?method=showAll">首页&nbsp;&nbsp;&gt;</a>
					<a href="#">${p.category.cname }</a>
				</div>
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						...
						<div style="margin:10px 0 10px 0;">黑马价: <strong style="color:#ef0101;">￥：${p.shop_price}元/份</strong> 参 考 价： <del>￥${p.market_price}元/份</del>
						</div>
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<script>
								function tiaozhuan(){
									...
									//alert(pid+"=="+count);
									//页面跳转
									location.href="${pageContext.request.contextPath}/cart?method=add&pid="+pid+"&count="+count;
								}
							</script>
					</div>
				</div>
